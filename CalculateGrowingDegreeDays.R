...
alldata = read_csv("/Users/Becca/Desktop/Adler Lab/Bromecast-reaction_norms/data/sat_sites/AllSitesWPandTemp4.csv")
...
YearlySummary %>% 
  ggplot(aes(x = reorder(Site,WP2cm), y = WP2cm)) + 
  geom_boxplot() +
...
YearlySummary %>% 
  ggplot(aes(x = reorder(Site,WP5cm), y = WP5cm)) + 
  geom_boxplot() +
  geom_hline(yintercept = -1.5, linetype = "solid", color = "black", size = 1) +
  theme_bw(base_size = 16) + theme(
    axis.text.x = element_text(angle = 90, hjust = 1)  # Rotate text 90 degrees (vertical)
...
MonthlySummary %>% 
  ggplot(aes(x = Month, y = WP2cm, color = Year)) +
  geom_point() +
  geom_line() +
  geom_hline(yintercept = -1.5, linetype = "solid", color = "black", size = 1) +
  facet_wrap(~Site) +
...
MonthlySummary %>% 
  ggplot(aes(x = Month, y = WP5cm, color = Year)) +
  geom_point() +
  geom_line() +
  geom_hline(yintercept = -1.5, linetype = "solid", color = "black", size = 1) +
  facet_wrap(~Site) +
